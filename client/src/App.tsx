  ...
  return <Sidebar className="border-r border-sidebar-border shadow-lg">
      ...
      <SidebarContent className="bg-sidebar">
        <SidebarMenu className="gap-1 px-2">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton onClick={() => setTechWorkflowsOpen(!techWorkflowsOpen)} isActive={location === "/replit-to-vercel" || location === "/lovable-prompts" || location === "/flutter-webview" || location === "/capacitor" || location === "/odoo-hosting"} className="transition-all duration-200 hover:bg-sidebar-accent hover:scale-[1.02] data-[active=true]:bg-sidebar-primary data-[active=true]:text-sidebar-primary-foreground data-[active=true]:shadow-md">
